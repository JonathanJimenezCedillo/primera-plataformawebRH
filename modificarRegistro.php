...
////////////////////////////7777
$numberEmpleado=$_POST['numberEmpli'];
////////////////////////////////
...
////////////////////////////////////////////////////////////
$sql ="SELECT * FROM registro WHERE numero_empleado='$numberEmpleado'";
...
<div class="form-group col-md-6">
	...
	<input type="text" name="fechaIngresoSindicato" class="tcal tcalInput form-control" class="form-control" id="inputZip" value="<?php echo "$Sindcdo" ?>" >
</div>
<div class="form-group col-md-6">
...
<select id="inputState" name="responsable" class="form-control">
	<option><?php echo "$Respoble" ?></option>
	<option value="SI">SI</option>
	<option value="NO">NO</option>
</select>
</div>
...
<?php
  ...
  header('Location:/documentacion_chimal/errordeRegistro.php');
}
?>
